...
namespace SURVEY_SYSTEM.BusinessLayer.Transaction
{
    public class MotorClmSurDtlManager
    {
        ...
        public DataTable FetchBySurdUid(MotorClmSurDtl objMotorClmSurDtl)
        {
            try
            {
                string query = $"SELECT SURD_UID, SURD_SUR_UID, SURD_ITEM_CODE, SURD_TYPE, SURD_UNIT_PRICE, SURD_QUANTITY," +
        ...
        //    }
        //}
        public bool CheckDuplicateSurdUid(MotorClmSurDtl objMotorClmSurDtl)
        {
            try
            {
                string query;
